...
const EmissionByCountryAnalysis = ({ isLoading }) => {
    ...
    const customSecondary = '#28B463'; // Custom secondary color
    const customTertiary = '#DAF7A6'; // Custom tertiary color
    const customDark = '#1C2833'; // Custom dark color for borders, dividers, etc.
    const customTextColor = '#E5E7E9'; // Custom text color
    const customDividerColor = '#566573'; // Custom divider color
